...
<!--heder end here-->
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="../admin/index.html">Home</a> <i class="fa fa-angle-right"></i></li>
            </ol>
<table width="500" height="390"
bgcolor="#F5F4F4">
welcome</table>
				...
				<div class="sidebar-menu">
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
										<li ><a href="#"><i class="fa fa-tachometer"></i>Home
										    <div class="clearfix"></div></a></li>
										
										
										 <li id="menu-academico" ><a href="../admin/admin_doc.php"><i class="fa fa-user"></i><span>Doctors</span><div class="clearfix"></div></a></li>
									<li><a href="../admin/admin_patient.php"><i class="fa fa-user" ></i><span>Patients</span><div class="clearfix"></div></a></li>
									 <li id="menu-academico" ><a href="../admin/admin_specialization.php"><i class="fa fa-file-text-o"></i>  <span>Department</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
									<li id="menu-academico" ><a href="../admin/admin_hospital.php"><i class="fa fa-file-text-o"></i>  <span>Hospital</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										<!--<ul id="menu-academico-sub" >
											<li id="menu-academico-boletim" ><a href="../admin/specialization_add.php">Add New</a></li>
											</ul>-->
