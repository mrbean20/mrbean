...
<!--heder end here-->
		<ol class="breadcrumb">
                <li class="breadcrumb-item">Home <i class="fa fa-angle-right"></i>Department</li>
                       ...
                       <?php 
						include("connect.php");
						$qry="select * from specialization";
						$res=mysql_query($qry);
						$i=1;
						?>
						  <table class="table table-bordered">
							...
							{ ?>
								<tr>
                                    <td><?php echo $i; ?></td>
                                    <?php $i++; ?>
									<td><?php echo $row['field_name']; ?>
                                   <td> <?php if($row['field_status']==1){
										?>
                                        <span class="label label-success">Active</span></a>
						                <?php } else{ ?>
                                        <span class="label label-warning">Blocked</span>
                                        <?php } ?> <span class="badge badge-primary"><a href="field_status_update.php?c_id=<?php echo $row['specialization_id']; ?>&&sts=<?php echo $row['field_status']; ?>" style="color:#FFFFFF">Update Status</a></td>
									
                                    <td><a href="specialization_edit.php?c_id=<?php echo $row['specialization_id']; ?>">Edit</a>
                           ...
                           <div class="menu">
									<ul id="menu" >
										<li ><a href="../admin/admin_home.php"><i class="fa fa-tachometer"></i>Home
										 ...
										 <li id="menu-academico" ><a href="../admin/specialization_add.php"><span>Add New</span><div class="clearfix"></div></a></li>
